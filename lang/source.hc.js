...
const grammar = {
  ...
  patterns: [
    ...
    {
      match:
        '\\b(break|case|continue|default|do|else|for|goto|if|return|switch|while|throw|try|catch|extern|MOV|CALL|PUSH|LEAVE|RET|SUB|SHR|ADD|RETF|CMP|JNE|BTS|INT|XOR|JC|JZ|LOOP|POP|TEST|SHL|ADC|SBB|JMP|INC)\\b',
      name: 'keyword.control.c'
    },
    {
      match:
        '\\b(U0|I8|U8|I16|U16|I32|U32|I64|U64|F64|Bool|class|union|DU8|DU16|DU32|DU64|RAX|RCX|RDX|RBX|RSP|RBP|RSI|RDI|EAX|ECX|EDX|EBX|ESP|EBP|ESI|EDI|AX|CX|DX|BX|SP|BP|SI|DI|SS|CS|DS|ES|FS|GS|CH)\\b',
      name: 'storage.type.c'
    },
    {
      match:
        '\\b(asm|const|extern|register|restrict|static|volatile|inline|_extern|_import|IMPORT|public)\\b',
    ...
    {match: '\\b(NULL|TRUE|FALSE|ON|OFF)\\b', name: 'constant.language.c'},
    {include: '#sizeof'},
    {
      captures: {
