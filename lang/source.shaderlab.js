...
const grammar = {
  ...
  patterns: [
    ...
    {
      match:
        '\\b(?i:Back|Front|On|Off|[RGBA]{1,3}|AmbientAndDiffuse|Emission)\\b',
      name: 'support.constant.property-value.shaderlab'
    },
    {
      match:
        '\\b(?i:Less|Greater|LEqual|GEqual|Equal|NotEqual|Always|Never)\\b',
      name: 'support.constant.property-value.comparisonfunction.shaderlab'
    },
    {
      match:
        '\\b(?i:Keep|Zero|Replace|IncrSat|DecrSat|Invert|IncrWrap|DecrWrap)\\b',
      name: 'support.constant.property-value.stenciloperation.shaderlab'
    },
    {
      match:
        '\\b(?i:Previous|Primary|Texture|Constant|Lerp|Double|Quad|Alpha)\\b',
  ...
  repository: {
    'hlsl-embedded': {
      patterns: [
        ...
        {
          match:
            '\\b(SurfaceOutputStandardSpecular|SurfaceOutputStandard|SurfaceOutput|Input)\\b',
    ...
    numbers: {
      patterns: [
        {match: '\\b([0-9]+\\.?[0-9]*)\\b', name: 'constant.numeric.shaderlab'}
      ]
    }
  },
