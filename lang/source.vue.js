...
const grammar = {
  ...
  patterns: [
    ...
    {include: '#self-closing-tag'},
    {
      ...
      patterns: [
        ...
        {
          begin:
            '([a-zA-Z0-9:-]+)\\b(?=[^>]*\\blang\\s*=\\s*([\'"]?)html\\b\\2)',
          beginCaptures: {1: {name: 'entity.name.tag.$1.html.vue'}},
          end: '(</)(\\1)\\s*(?=>)',
          endCaptures: {
            1: {name: 'punctuation.definition.tag.begin.html.vue'},
        ...
        {
          begin:
            '([a-zA-Z0-9:-]+)\\b(?=[^>]*\\blang\\s*=\\s*([\'"]?)stylus\\b\\2)',
          beginCaptures: {1: {name: 'entity.name.tag.$1.html.vue'}},
          end: '(</)(\\1)\\s*(?=>)',
          endCaptures: {
            1: {name: 'punctuation.definition.tag.begin.html.vue'},
        ...
        {
          begin:
            '([a-zA-Z0-9:-]+)\\b(?=[^>]*\\blang\\s*=\\s*([\'"]?)postcss\\b\\2)',
          beginCaptures: {1: {name: 'entity.name.tag.$1.html.vue'}},
          end: '(</)(\\1)\\s*(?=>)',
          endCaptures: {
            1: {name: 'punctuation.definition.tag.begin.html.vue'},
        ...
        {
          begin:
            '([a-zA-Z0-9:-]+)\\b(?=[^>]*\\blang\\s*=\\s*([\'"]?)sass\\b\\2)',
          beginCaptures: {1: {name: 'entity.name.tag.$1.html.vue'}},
          end: '(</)(\\1)\\s*(?=>)',
          endCaptures: {
            1: {name: 'punctuation.definition.tag.begin.html.vue'},
        ...
        {
          begin:
            '([a-zA-Z0-9:-]+)\\b(?=[^>]*\\blang\\s*=\\s*([\'"]?)scss\\b\\2)',
          beginCaptures: {1: {name: 'entity.name.tag.$1.html.vue'}},
          end: '(</)(\\1)\\s*(?=>)',
          endCaptures: {
            1: {name: 'punctuation.definition.tag.begin.html.vue'},
        ...
        {
          begin:
            '([a-zA-Z0-9:-]+)\\b(?=[^>]*\\blang\\s*=\\s*([\'"]?)less\\b\\2)',
          beginCaptures: {1: {name: 'entity.name.tag.$1.html.vue'}},
          end: '(</)(\\1)\\s*(?=>)',
          endCaptures: {
            1: {name: 'punctuation.definition.tag.begin.html.vue'},
        ...
        {
          begin:
            '([a-zA-Z0-9:-]+)\\b(?=[^>]*\\blang\\s*=\\s*([\'"]?)coffee\\b\\2)',
          beginCaptures: {1: {name: 'entity.name.tag.$1.html.vue'}},
          end: '(</)(\\1)\\s*(?=>)',
          endCaptures: {
            1: {name: 'punctuation.definition.tag.begin.html.vue'},
        ...
        {
          begin:
            '([a-zA-Z0-9:-]+)\\b(?=[^>]*\\blang\\s*=\\s*([\'"]?)json\\b\\2)',
          beginCaptures: {1: {name: 'entity.name.tag.$1.html.vue'}},
          end: '(</)(\\1)\\s*(?=>)',
          endCaptures: {
            1: {name: 'punctuation.definition.tag.begin.html.vue'},
        ...
        {
          begin:
            '([a-zA-Z0-9:-]+)\\b(?=[^>]*\\blang\\s*=\\s*([\'"]?)jsonc\\b\\2)',
          beginCaptures: {1: {name: 'entity.name.tag.$1.html.vue'}},
          end: '(</)(\\1)\\s*(?=>)',
          endCaptures: {
            1: {name: 'punctuation.definition.tag.begin.html.vue'},
        ...
        {
          begin:
            '([a-zA-Z0-9:-]+)\\b(?=[^>]*\\blang\\s*=\\s*([\'"]?)json5\\b\\2)',
          beginCaptures: {1: {name: 'entity.name.tag.$1.html.vue'}},
          end: '(</)(\\1)\\s*(?=>)',
          endCaptures: {
            1: {name: 'punctuation.definition.tag.begin.html.vue'},
        ...
        {
          begin:
            '([a-zA-Z0-9:-]+)\\b(?=[^>]*\\blang\\s*=\\s*([\'"]?)yaml\\b\\2)',
          beginCaptures: {1: {name: 'entity.name.tag.$1.html.vue'}},
          end: '(</)(\\1)\\s*(?=>)',
          endCaptures: {
            1: {name: 'punctuation.definition.tag.begin.html.vue'},
        ...
        {
          begin:
            '([a-zA-Z0-9:-]+)\\b(?=[^>]*\\blang\\s*=\\s*([\'"]?)toml\\b\\2)',
          beginCaptures: {1: {name: 'entity.name.tag.$1.html.vue'}},
          end: '(</)(\\1)\\s*(?=>)',
          endCaptures: {
            1: {name: 'punctuation.definition.tag.begin.html.vue'},
        ...
        {
          begin:
            '([a-zA-Z0-9:-]+)\\b(?=[^>]*\\blang\\s*=\\s*([\'"]?)(gql|graphql)\\b\\2)',
          beginCaptures: {1: {name: 'entity.name.tag.$1.html.vue'}},
          end: '(</)(\\1)\\s*(?=>)',
          endCaptures: {
            1: {name: 'punctuation.definition.tag.begin.html.vue'},
  ...
  repository: {
    'html-stuff': {
      patterns: [{include: '#template-tag'}, {include: 'text.html.basic'}]
    },
    'self-closing-tag': {
      begin: '(<)([a-zA-Z0-9:-]+)(?=([^>]+/>))',
      beginCaptures: {
    ...
    'template-tag': {
      patterns: [{include: '#template-tag-1'}, {include: '#template-tag-2'}]
    },
    'template-tag-1': {
      begin: '(<)(template)\\b(>)',
      beginCaptures: {
      ...
      patterns: [
        {
          ...
          endCaptures: {
            1: {name: 'punctuation.definition.string.end.html.vue'}
          },
          patterns: [
            {
              begin: '(?<=(\'|"|`))',
      ...
      patterns: [
        {
          begin: '(\'|")',
          beginCaptures: {
            1: {name: 'punctuation.definition.string.begin.html.vue'}
          },
          end: '(\\1)',
          endCaptures: {
            1: {name: 'punctuation.definition.string.end.html.vue'}
      ...
      patterns: [
        {
          begin: '(\\{\\{)',
          beginCaptures: {
            1: {name: 'punctuation.definition.interpolation.begin.html.vue'}
          },
          end: '(\\}\\})',
          endCaptures: {
            1: {name: 'punctuation.definition.interpolation.end.html.vue'}
          },
